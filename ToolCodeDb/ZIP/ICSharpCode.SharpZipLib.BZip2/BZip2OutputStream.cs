...
namespace ICSharpCode.SharpZipLib.BZip2
{
	public class BZip2OutputStream : Stream
	{
				...
				for (m = 0; m < this.nMTF; m = num7 + 1)
				{
					...
					else
					{
						for (int num23 = m; num23 <= num7; num23++)
						{
							...
							{
								short[] expr_2F2_cp_0 = array4;
								int expr_2F2_cp_1 = num25;
								expr_2F2_cp_0[expr_2F2_cp_1] += (short)array[num25][(int)num24];
							}
						}
					}
					int num26 = 999999999;
		...
		private void QSort3(int loSt, int hiSt, int dSt)
		{
			...
			{
				array[i] = new BZip2OutputStream.StackElement();
			}
			int j = 0;
			array[j].ll = loSt;
			array[j].hh = hiSt;
		...
		private void RandomiseBlock()
		{
			...
			for (int i = 0; i <= this.last; i++)
			{
				...
				num--;
				byte[] expr_4C_cp_0 = this.block;
				int expr_4C_cp_1 = i + 1;
				expr_4C_cp_0[expr_4C_cp_1] ^= (byte)((num == 1) ? 1 : 0);
				byte[] expr_70_cp_0 = this.block;
